...
type Review struct {
	...
	PositiveComment string   `json:"positive" db:"positive"`             // достоинства
	NegativeComment string   `json:"negative" db:"negative"`             // недостатки
	IsLocalResident bool     `json:"local_resident" db:"local_resident"` // местный?
